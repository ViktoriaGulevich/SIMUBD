...
(
	...
	passportNumber	varchar(100) check (passportNumber like '[A-Z][A-Z][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'),
	dateOfBirth		date,
	address			varchar(100),
	city			varchar(100),
	phone			varchar(100) check (phone like '[1-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9]')
);
...
(
	...
	pansionatId		bigint foreign key references pansionat (pansionatId),
	description		varchar(255),
...
(
	...
	housTypeId		bigint foreign key references housType (housTypeId),
...
(
	...
	clientId			bigint foreign key references client (clientId),
	tourId				bigint foreign key references tour (tourId),
	arrivalDate			date,
	departureDate		date,
	isHaveKids			bit,
...
values ('Ivanov','Ivan','','AB1234567','2000-01-01','','','12-34-567'),
('Petrov','Petr','','AB1234568','2000-01-01','','','12-34-567'),
('Sidorov','Sidor',null,'AB1234569','2000-01-01','','','12-34-567'),
('Pavlov','Pavel',null,'AB1234560','2000-01-01','','','12-34-567'),
('Svetlov','Svet','','AB1234570','2000-01-01','','','12-34-567'),
('For Left/Right','Join','','AB1234571','2000-01-01','','','12-34-567');
...
values ('pansionat1', 'address1', 'Minsk', 'Belarus', '12-34-567', '', 100, 1, 1, 1, 3, 1000),
('pansionat2', 'address2', 'Minsk', 'Belarus', '12-34-567', '', 100, 1, 1, 1, 4, 1000),
('pansionat3', 'address3', 'Brest', 'Belarus', '12-34-567', '', 150, 1, 1, 0, 5, 1000),
('pansionat4', 'address4', 'Brest', 'Belarus', '12-34-567', '', 50, 1, 0, 1, 2, 1000),
('pansionat5', 'address5', 'Grodno', 'Belarus', '12-34-567', '', 100, 0, 1, 0, 3, 1000),
('left/right', 'join', 'Grodno', 'Belarus', '12-34-567', '', 100, 0, 1, 0, 3, 1000);
...
('tour3','plane',2,'3 time',20),
('tour4','car',6,'3 time',20),
('tour5','ship',5,'3 time',20),
('tour6','plane',4,'3 time',20),
('tour7','car',9,'3 time',20),
('tour8','ship',7,'3 time',20),
('tour9','car',8,'3 time',20),
('tour10','plane',4,'3 time',20),
('tour11','car',6,'3 time',20),
('tour12','car',7,'3 time',20),
('tour13','ship',3,'3 time',20),
('tour14','plane',1,'3 time',20),
('tour15','car',8,'3 time',20),
('tour16','car',2,'3 time',20),
('tour17','car',9,'3 time',20),
('tour18','ship',3,'3 time',20),
('tour19','plane',9,'3 time',20),
('tour20','car',7,'3 time',20);
...
(1, 16, '2022-09-21', '2022-10-20', 1, 1, 2, 1000, 2500),
...
(4, 1, '2022-09-25', '2022-10-21', 1, 0, 2, 1000, 2000),
(3, 2, '2022-09-21', '2022-10-15', 1, 1, 2, 2000, 4000),
(2, 3, '2022-09-22', '2022-10-20', 1, 0, 1, 1000, 1000),
(1, 4, '2022-09-23', '2022-10-10', 0, 1, 2, 1000, 2000),
...
(5, 9, '2022-09-23', '2022-10-21', 0, 1, 1, 3000, 3000),
(1, 7, '2022-09-25', '2022-10-15', 1, 1, 2, 1000, 2000);
